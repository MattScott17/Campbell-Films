...
export default function Footer() {
  return (
    <footer className="bg-sage-100 border-t border-sage-200 mt-20">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
          ...
          <div className="text-center md:text-right">
            <a
              ...
              className="text-olive-700 hover:text-coral-500 transition-colors block mb-3"
            >
            ...
            <div className="flex space-x-4 justify-center md:justify-end">
              <a
                ...
                className="text-olive-700 hover:text-coral-500 transition-colors"
        ...
        <div className="mt-8 pt-8 border-t border-sage-200 text-center">
          <p className="text-sm text-olive-600">
            &copy; {new Date().getFullYear()} Campbell Films. All rights
            reserved.
          </p>
        </div>
      </div>
